<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="flex items-center justify-end mt-4">
            <a class="underline text-sm text-gray-600 hover:text-[#0A4D2E] rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#6BBF8B]" href="{{ route('login') }}">
                Ya tienes cuenta?
            </a>
